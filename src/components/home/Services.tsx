  ...
  return (
    <>
      ...
      <div className="w-full py-12" style={{
        ...
        <div className="flex justify-center items-center gap-6 text-center text-xl">
          <span style={{ fontFamily: fonts.spaceMono, letterSpacing: '0.4em', color: 'rgba(17,17,17,0.5)' }}>
            WE ARE A FULL-SPECTRUM CREATIVE STUDIO
          </span>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-3/4">
            {servicesList.map((svc, i) => (
              <div key={svc.id} className="svc-row py-6 px-8 flex items-baseline gap-6 group" style={{
                opacity: servicesAnim.visible ? 1 : 0,
                ...
                <div className="flex-1">
                  ...
                  <p className="svc-detail mt-1 text-xs text-gray-400 group-hover:text-white transition-colors duration-300" style={{ fontFamily: fonts.spaceMono, lineHeight: 1.6 }}>{svc.detail}</p>
                </div>
